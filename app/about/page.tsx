...
export const metadata: Metadata = {
  title: meta.about,
  description: 'Meet Alexis Lyon, trauma-informed transformational guide and healer based in Costa Rica with 22 years of clinical depth.',
  alternates: { canonical: '/about' },
  openGraph: {
    title: 'About Alexis Lyon — 22 Years of Clinical Depth',
    description: '22 years of clinical depth — in service of your becoming.',
    images: [{ url: '/api/og?title=About+Alexis+Lyon&sub=In+Service+of+Your+Becoming', width: 1200, height: 630, alt: 'About Alexis Lyon' }]
  },
  twitter: { card: 'summary_large_image', images: ['/api/og?title=About+Alexis+Lyon&sub=In+Service+of+Your+Becoming'] }
};
        ...
        <div className="container max-w-3xl">
          <div className="flex flex-col items-center">
            ...
            <div className="mt-10 text-center">
              <p className="eyebrow">You are the heroine of this story</p>
              <h1 className="display mt-5 text-5xl text-forest">22 years of clinical depth — in service of your becoming.</h1>
            </div>
          </div>

          <div className="mt-10 space-y-6 text-mid leading-8">
              <p className="italic">I am so glad you are here.</p>
              <p>My name is Alexis Lyon. I am a transformational guide and healer whose work is rooted in over two decades of trauma-informed clinical depth — and I work with people who are ready to stop outsourcing their knowing and finally learn to trust and love themselves.</p>
              ...
              <div className="relative aspect-[4/3] overflow-hidden rounded-[2rem] shadow-soft">
                <Image src="/images/nature-alpine-meadow.webp" alt="Orange and yellow wildflowers in a green alpine meadow beneath snowy mountain peaks and a vivid blue sky" fill className="object-cover" sizes="(max-width: 815px) calc(100vw - 3rem), 768px" />
              </div>
          ...
          <Link className="btn btn-forest mt-8 inline-block" href="/connect">Let&rsquo;s Begin — Free 20-Minute Consultation</Link>
        </div>
      </section>
