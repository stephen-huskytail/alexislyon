        ...
        <div className="container max-w-3xl">
          ...
          <div className="mt-10 space-y-6 leading-8 text-mid">
            ...
            <blockquote className="rounded-[2rem] bg-warm p-8">
              <p className="display text-2xl italic leading-relaxed text-forest">“Are you engaging the processes of change that matter most for this individual in their particular situation?”</p>
            </blockquote>
