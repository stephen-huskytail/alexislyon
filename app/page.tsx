  ...
  return (
    <main id="page-content">
      ...
      <section id="hero" className="dark-section dark relative flex min-h-screen items-center overflow-hidden bg-forest-orbs">
        <Image
          src="/images/nature/hero-canopy.webp"
          alt=""
          fill
          priority
      ...
      <section id="wound-wild" className="section bg-warm">
        <div className="container">
          <Reveal><p className="eyebrow">The wound & the wildness</p><h2 className="display mt-5 max-w-3xl text-5xl text-forest">Two territories. Two kinds of homecoming. One You.</h2><p className="body-large mt-6 max-w-4xl text-mid">Some of what you carry needs healing. Some of what you carry needs reclaiming. Learning to tell the difference is itself a form of self-trust and self-love.</p></Reveal>
          <div className="mt-12 grid gap-4 md:grid-cols-2">
            <article className="overflow-hidden rounded-[2rem] bg-cream shadow-soft">
              <div className="relative h-64"><Image src="/images/nature/wound-still-water.webp" alt="A sheltered still pool surrounded by moss and ferns" fill className="object-cover" sizes="(max-width: 768px) 100vw, 50vw" /></div>
              <div className="p-8"><p className="eyebrow">What needs healing</p><h3 className="display mt-5 text-4xl text-forest">The Wound</h3><p className="mt-5 leading-8 text-mid">The wound is what happened to you. It asks for witnessing, compassion, grief, and the kind of presence that says: I see you.</p></div>
            </article>
            <article className="overflow-hidden rounded-[2rem] bg-cream shadow-soft">
              <div className="relative h-64"><Image src="/images/nature/wildness-ocean.webp" alt="Pacific waves moving toward a lush Costa Rican shoreline" fill className="object-cover" sizes="(max-width: 768px) 100vw, 50vw" /></div>
              <div className="p-8"><p className="eyebrow">What needs reclaiming</p><h3 className="display mt-5 text-4xl text-forest">The Wildness</h3><p className="mt-5 leading-8 text-mid">The wildness is not what happened to you. It is the power, truth, and fierce knowing that learned it was not welcome — and wants to come home.</p></div>
            </article>
          </div>
        </div>
      </section>
      ...
      <section id="experience" className="section"><div className="container grid gap-10 lg:grid-cols-2"><div><p className="eyebrow">Forest Body Activation</p><h2 className="display mt-5 text-5xl text-forest">A guided doorway into the work.</h2><p className="body-large mt-6 text-mid">A guided meditation to help you find your way home to your body — and the three practices I will leave you with to take into your daily life.</p><Link className="btn btn-forest mt-8 hidden lg:inline-flex" href="/connect">Ready for more? Let&rsquo;s talk.</Link></div><div className="rounded-[2rem] bg-forest p-8 text-cream"><div className="relative w-full" style={{paddingTop:'56.25%'}}><iframe src="https://customer-ztqqgp1me9w0o1u1.cloudflarestream.com/d33dccdea5f1a8572569f5301b9cabaf/iframe?poster=https%3A%2F%2Falexislyon.com%2Fimages%2Fforest-body-cover.webp" loading="lazy" className="absolute inset-0 h-full w-full rounded-2xl border-0" allow="accelerometer; gyroscope; autoplay; encrypted-media; picture-in-picture" allowFullScreen /></div><ForestBodyForm /></div><Link className="btn btn-forest lg:hidden justify-self-start" href="/connect">Ready for more? Let&rsquo;s talk.</Link></div></section>
