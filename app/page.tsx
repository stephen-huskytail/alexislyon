...
export default function Home() {
  return (
    <main id="page-content">
      ...
      <section id="experience" className="section"><div className="container grid gap-10 lg:grid-cols-2"><div><p className="eyebrow">Forest Body Activation</p><h2 className="display mt-5 text-5xl text-forest">A guided doorway into the work.</h2><p className="body-large mt-6 text-mid">A guided meditation to help you find your way home to your body — and the three practices I will leave you with to take into your daily life.</p></div><div className="rounded-[2rem] bg-forest p-8 text-cream"><div className="aspect-video rounded-2xl border border-cream/20 bg-cream/10 flex flex-col items-center justify-center gap-4 text-center px-8"><p className="display text-2xl text-gold-lt">Coming Soon</p><p className="text-sm leading-7 text-cream/80">Video and audio coming soon. Enter your email below to be the first to receive it.</p></div><form className="mt-6 flex gap-3 max-sm:flex-col"><input placeholder="Email for the audio download" /><button className="btn btn-gold shrink-0" type="button">Receive Audio</button></form></div></div></section>
