...
export default function Home() {
  return (
    <main id="page-content">
      ...
      <section id="relationship" className="section"><div className="container"><p className="eyebrow">The healing relationship</p><h2 className="display mt-5 max-w-3xl text-5xl text-forest">The relationship is the medicine.</h2><div className="mt-10 grid gap-1 md:grid-cols-4">{[{label:'Witnessing',img:'/images/card-witnessing.jpg',pos:'center top'},{label:'Co-regulating',img:'/images/card-coregulating-v2.jpg',pos:'center 22%'},{label:'Practicing presence',img:'/images/card-presence.jpg',pos:'center top'},{label:'Returning to truth',img:'/images/card-truth.jpg',pos:'center 46%'}].map(({label,img,pos}) => <div className="overflow-hidden rounded-2xl" key={label}><div className="relative h-64 w-full"><Image src={img} alt={label} fill className="object-cover" style={{objectPosition:pos}} sizes="(max-width:768px) 100vw, 25vw" /></div><div className="bg-cream p-6"><h3 className="display text-2xl text-forest">{label}</h3></div></div>)}</div></div></section>
