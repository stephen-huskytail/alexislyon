...
export default function Home() {
  return (
    <main id="page-content">
      ...
      <Nav />
      <section id="hero" className="dark-section dark relative flex min-h-screen items-center overflow-hidden">
        <Image src="/images/nature-sunlit-forest.webp" alt="" fill priority sizes="100vw" className="object-cover object-[65%_center]" />
        <div className="absolute inset-0 bg-gradient-to-r from-forest/90 via-forest/75 to-forest/50" aria-hidden="true" />
      ...
      <section id="permission" className="section bg-forest text-cream"><div className="container grid gap-12 lg:grid-cols-[.9fr_1.1fr]"><Reveal><div><p className="eyebrow !text-gold-lt">A different kind of permission</p><h2 className="display mt-5 text-6xl">You do not have to be finished to begin.</h2><div className="relative mt-8 aspect-[4/5] max-w-[30rem] overflow-hidden rounded-[2rem] shadow-soft"><Image src="/images/nature-ocean-sunset.webp" alt="Golden sunset reflected across a calm ocean" fill className="object-cover" sizes="(max-width: 1023px) calc(100vw - 3rem), 30rem" /></div></div></Reveal><div><p className="body-large text-cream/85">You may have been told — or told yourself — that you need to finish healing before you are allowed to start living. That the wound must close before the dream can open. I want to say this to you clearly: that is not true. You can be exactly where you are and take real steps toward the life you long for. Both. At the same time. Starting now.</p><div className="mt-8 grid gap-3 sm:grid-cols-2">{permissions.map((p) => <p key={p} className="rounded-2xl bg-cream/10 p-4">{p}</p>)}</div><p className="display mt-9 text-3xl italic text-cream">&ldquo;You are worth the effort. You always were.&rdquo;</p><div className="mt-9"><Link className="btn btn-gold" href="/connect">I&rsquo;m ready to begin.</Link></div></div></div></section>

      <section id="wound-wild" className="section bg-warm"><div className="container"><Reveal><p className="eyebrow">The wound & the wildness</p><h2 className="display mt-5 max-w-3xl text-5xl text-forest">Two territories. Two kinds of homecoming. One You.</h2><p className="body-large mt-6 max-w-4xl text-mid">Some of what you carry needs healing. Some of what you carry needs reclaiming. Learning to tell the difference is itself a form of self-trust and self-love.</p></Reveal><div className="mt-12 grid gap-1 md:grid-cols-2"><div className="card bg-cream"><div className="relative mb-7 aspect-[16/9] overflow-hidden rounded-2xl"><Image src="/images/nature-turquoise-water.webp" alt="Sunlight rippling through clear turquoise water" fill sizes="(max-width: 767px) calc(100vw - 6rem), 520px" className="object-cover" /></div><p className="eyebrow">What needs healing</p><h3 className="display mt-5 text-4xl text-forest">The Wound</h3><p className="mt-5 leading-8 text-mid">The wound is what happened to you. It asks for witnessing, compassion, grief, and the kind of presence that says: I see you.</p></div><div className="card bg-cream"><div className="relative mb-7 aspect-[16/9] overflow-hidden rounded-2xl"><Image src="/images/nature-green-hills.webp" alt="Soft green hills unfolding toward misty forested ridges" fill sizes="(max-width: 767px) calc(100vw - 6rem), 520px" className="object-cover" /></div><p className="eyebrow">What needs reclaiming</p><h3 className="display mt-5 text-4xl text-forest">The Wildness</h3><p className="mt-5 leading-8 text-mid">The wildness is not what happened to you. It is the power, truth, and fierce knowing that learned it was not welcome — and wants to come home.</p></div></div></div></section>
