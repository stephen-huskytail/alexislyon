...
export default function Home() {
  return (
    <main id="page-content">
      ...
      <section id="natural-world" className="section bg-warm"><div className="container grid items-center gap-12 lg:grid-cols-[1.1fr_.9fr]"><Reveal><div className="relative aspect-[4/3] overflow-hidden rounded-[2rem] shadow-soft"><Image src="/images/sunset-tree-landscape.webp" alt="A tree silhouetted against a warm sunset sky" fill className="object-cover" sizes="(max-width: 1023px) 100vw, 55vw" /></div></Reveal><Reveal delay={0.12}><div><p className="eyebrow">Rooted in the natural world</p><h2 className="display mt-5 text-5xl text-forest">The natural world remembers the way home.</h2><p className="body-large mt-6 text-mid">In its rhythms, spaciousness, and quiet presence, the natural world offers a gentle reminder that you belong to something larger — and that your body can find its own way back to ground.</p></div></Reveal></div></section>
